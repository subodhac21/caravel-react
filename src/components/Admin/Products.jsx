...
const Products = () => {
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    ...
    <div className="w-full md:w-1/3 px-3">
      ...
      <input value={vars.pprice} name='pprice' onInput={(e)=>{changeField(e)}} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" />
    </div>
    <div className="w-full md:w-1/3 px-3">
      <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="grid-last-name">
        Product Quantity
      </label>
      <input value={vars.pquant} name='pquant' onInput={(e)=>{changeField(e)}} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" step={1000} />
    </div>
  </div>
  <div className="flex flex-wrap -mx-3 mb-6 md:w-100">
    ...
    <div className="w-full md:w-1/2 px-3">
      ...
      <input type="file" value={vars.pquant} name='pquant' onInput={(e)=>{changeField(e)}} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" />
    </div>
  </div>
